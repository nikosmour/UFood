                        ...
                        <v-card :loading="isLoading" :title="$t('transaction.info')" flat>
                            <v-form ref="receiverForm" v-model="isFormValid" validate-on="invalid-input lazy"
                                ...
                                <v-row>
                                    ...
                                    <v-col v-for="(meal, index) in mealPlanPeriods" :key="'form.meals.' + index"
...
export default {
        ...
        return {
            ...
            rules: {
                receiver: [
                    ...
                    value => (value > 0) || this.$t('validation.exists', {attribute: this.$t('validation.attributes.receiver_id')}),
    ...
    computed: {
         ...
         */
        listItems() {
            return {receiver: this.receiver, meals: this.mealQuantities};
        },
    ...
    methods: {
        ...
        validateMeals(key) {
            return newValue => {
                ...
                if (newValue === 0 && Object.values(this.mealQuantities).every(q => q === 0)) {
        ...
        resetForm() {
            ...
            this.step = 1;
            this.receiver = {transaction_id: null, id: '', name: null, status: null};
