...
return [
    ...
    */
    ...
    'at_least_one_greater_than_zero' => 'Τουλάχιστον μια τιμή πρέπει να είναι μεγαλύτερη του 0',
    'differentCategoryCoupons' => 'Δεν είστε δικαιούχος της ίδιας κατηγορίας κουπονιών.',
    'coupon_insufficient' => 'Μη επαρκές υπόλοιπο κουπονιών',
    'card_had_used' => 'Η κάρτα έχει ήδη χρησιμοποιηθεί για αυτό το γεύμα',
    'card_expired_or_not_exist' => 'Κάρτα χρησιμοποιημένη ή μη υπαρκτή',
    ...
    */
    ...
    'attributes' => [
        ...
        'card_application_staff_comment' => 'Σχόλιο προσωπικού',
        'coupon_owner' => 'Ιδιοκτήτης κουπονιών',
        'BREAKFAST' => 'πρωινό',
        'LUNCH' => 'μεσημεριανό',
        'DINNER' => 'βραδινό',
